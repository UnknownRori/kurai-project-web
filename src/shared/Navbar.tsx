...
const InActiveClassName = "px-4 py-2 text-center hover:bg-primary-50 hover:shadow-sm shadow-white hover:text-text-950 duration-500";
    ...
    return (
        <li className="flex items-center justify-center">
            <NavLink to={props.to} className={({ isActive }) => {
                return (isActive
                    ? "bg-white border-white px-4 py-2 text-center flex text-black font-bold shadow-md shadow-white hover:shadow-lg"
                    : InActiveClassName) + " border-2 border-secondary-800 hover:border-white text-center rounded-md duration-500";
            }}>
                {props.children}
            </NavLink>
        </li>
...
export function Navbar() {
    ...
    return (
        <nav className="flex relative justify-between items-center py-4 px-12 gap-8 bg-black border-[1px] border-secondary-800">
            ...
            <div className={`lg:flex sm:border-primary-900 sm:border-2 lg:border-0
                ...
                justify-center items-center text-white transition-all duration-500 bg-black`}>
                <ul className="flex gap-4 md:flex-row sm:flex-col">
                    ...
                    <li className="flex items-center justify-center border-2 border-accent-500 hover:border-white text-center rounded-md duration-500 shadow-white shadow-md transition-all">
